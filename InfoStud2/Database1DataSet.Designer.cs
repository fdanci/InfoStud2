...
namespace InfoStud2 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(string Name, string Email, string Year) {
...
namespace InfoStud2.Database1DataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_" +
                "Name) AND ([Email] = @Original_Email) AND ([Year] = @Original_Year))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Name], [Email], [Year]) VALUES (@Name, @Email, @Yea" +
                "r);\r\nSELECT Id, Name, Email, Year FROM Student WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Name] = @Name, [Email] = @Email, [Year] = @Year WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Email] = @Original_Email) AND ([Year] = @Original_Year));
SELECT Id, Name, Email, Year FROM Student WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Email, Year FROM dbo.Student";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Email, string Original_Year) {
        ...
        public virtual int Insert(string Name, string Email, string Year) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Email, string Year, int Original_Id, string Original_Name, string Original_Email, string Original_Year, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Email, string Year, int Original_Id, string Original_Name, string Original_Email, string Original_Year) {
            return this.Update(Name, Email, Year, Original_Id, Original_Name, Original_Email, Original_Year, Original_Id);
        }
    }
